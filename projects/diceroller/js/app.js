//make a new app w/ debugger info
...
//the router to define what roll does
Roller.Router.map(function () { 
    this.resource("roll");
});

//router to redirect index page to roll page
...
//the logic of the app, and the rolls and stuff.
...
//lets you just push enter on text field to roll
